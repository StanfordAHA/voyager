...
set dc_extra_link_libraries     [eval "$::env(typ_dbs)"]

#-------------------------------------------------------------------------
# Interface to the ASIC design kit
#-------------------------------------------------------------------------

set dc_milkyway_ref_libraries   [eval "$::env(ref_libs)"]
...
set dc_target_libraries         {}
set dc_tar_lib 					[eval "$::env(target_dbs)"]
foreach lib $dc_tar_lib {
	lappend dc_target_libraries [file tail $lib]
}


# Extra libraries

set dc_additional_search_path   $::env(additional_search_path)

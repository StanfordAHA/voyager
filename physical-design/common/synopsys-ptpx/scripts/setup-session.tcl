...
# Keep clock gating and recovery/removal timing group even if user constraints could overwrite them
set_app_var timing_enable_override_default_groups false

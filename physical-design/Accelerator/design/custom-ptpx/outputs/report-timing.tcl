...
report_constraints -all_violators -verbose > $ptpx_reports_dir/$ptpx_design_name.timing.constraints.violators.rpt
...
report_timing -delay max \
	...
	-pba_mode exhaustive \
	> $ptpx_reports_dir/$ptpx_design_name.timing.pba.setup.rpt
...
report_timing -delay min \
	...
	-input -net -crosstalk_delta -nosplit -capacitance -transition_time \
	-pba_mode exhaustive \
	> $ptpx_reports_dir/$ptpx_design_name.timing.pba.hold.rpt

...
report_timing \
  ...
  -path_type full_clock -attributes -sort_by slack \
...
# Report constraints and path groups
...
report_constraint \
  ...
  -all_violators  \
  -significant_digits 4 \
  > ${dc_reports_dir}/${dc_design_name}.mapped.all_violations.rpt

report_timing_requirements \
  > ${dc_reports_dir}/${dc_design_name}.mapped.timing.requirements.rpt

report_path_group > ${dc_reports_dir}/${dc_design_name}.mapped.path_group.rpt

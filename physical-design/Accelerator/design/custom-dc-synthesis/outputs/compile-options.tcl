...
if {$dc_flatten_effort == 0} {
  ...
  # TODO: is there a better command than this? This would take effect right away
  # set_ungroup false would be overwritten. Would prefer a command that takes effect at compile_ultra time

...
FILES {
  ...
  { FILENAME memories/ip224rfsbhpm1r1w512x64m1.v     FILETYPE SystemVerilog MODELTYPE generic PARSE 1 PATHTYPE relative STATICFILE 1 VHDL_LIB_MAPS work }
  { FILENAME memories/ip224rfsbhpm1r1w256x64m1.v     FILETYPE SystemVerilog MODELTYPE generic PARSE 1 PATHTYPE relative STATICFILE 1 VHDL_LIB_MAPS work }
  { FILENAME memories/ip224rfsbhpm1r1w128x64m1.v     FILETYPE SystemVerilog MODELTYPE generic PARSE 1 PATHTYPE relative STATICFILE 1 VHDL_LIB_MAPS work }
}
VHDLARRAYPATH    {}
LINK_LIBRARY     {}
WRITEDELAY       0.1
...
PARAMETERS {
  ...
  # If we support variable width, then min can be lowered to 32

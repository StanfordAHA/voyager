...
def parse_args():
    parser = argparse.ArgumentParser(description='Parse tensor.bin files generated by voyager compiler')
    parser.add_argument('--model', type=str, default='resnet18',)
    parser.add_argument('--layer', type=str, default='submodule_0',)
    parser.add_argument('--datatype', type=str, default='MXINT8',)
...
def parse_tensors(model, layer, datatype, debug_mode):
